...
public class Home {
        ...
        try {
            ...
            wait.until(ExpectedConditions.or(
                    ExpectedConditions.textToBePresentInElementLocated(By.className("css-yg30e6"),
                            product),
                    ExpectedConditions.presenceOfElementLocated(By.xpath("//h4"))));
            Thread.sleep(3000);
            return true;
        } catch (Exception e) {
    ...
    public Boolean isNoResultFound() {
        ...
        try {
            ...
            status = driver.findElementByXPath("//div[@id = 'root']//h4").isDisplayed();
            return status;
        } catch (Exception e) {
            return status;
        }
        ...
        try {
            ...
            for (WebElement cartItem : cartContents) {
                actualCartContents.add(cartItem
                        .findElement(By.className("css-1gjj37g"))
                        .getText().split("\n")[0]);
            }
