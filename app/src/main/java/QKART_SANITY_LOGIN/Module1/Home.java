...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            return true;
            // WebElement searchbox = driver.findElementByXPath(
            //         "//div[@class='header MuiBox-root css-0']//input[@placeholder='Search for items/categories']");
            // searchbox.clear();
            // searchbox.sendKeys(product);
        } catch (Exception e) {
    ...
    public List<WebElement> getSearchResults() {
        ...
        try {
            ...
            //searchResults = driver.findElements(By.xpath("//div[contains(@class,'MuiCardContent-root css-1qw96cp')]"));
    ...
    public Boolean isNoResultFound() {
        ...
        try {
            ...
            WebElement noResultFound = driver.findElement(By.xpath("//h4[contains(text(),'No products found')]"));
    ...
    public Boolean addProductToCart(String productName) {
        try {
            ...
            String xpathProdName = "//*[contains(text(),'" + productName + "')]//following::button[1]";
            ...
            /*for (WebElement webElements : productElements) {
                WebElement searchedProductName = webElements.findElement(By.tagName("p"));
    ...
    public Boolean changeProductQuantityinCart(String productName, int quantity) {
        try {
            ...
            for (WebElement item : cartContents) {
                if (item.findElement(By.className("css-1gjj37g")).getText()
                    ...
                    while (currentQty != quantity) {
                        ...
                        if (currentQty < quantity) {
                                ...
                                currentQty = Integer.valueOf(item
