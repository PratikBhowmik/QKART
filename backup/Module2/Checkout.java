    ...
    public Boolean addNewAddress(String addresString) {
        try {
            ...
            if (addNewAddressButton.isDisplayed()) {
                ...
                addBtn.click();
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(@class,'address-item not-selected MuiBox-root css-0')]/div/following::div[1]/button")));
            }
            return true;
        } catch (Exception e) {
