...
public class QkartSanity {
        ...
        public static RemoteWebDriver createDriver() throws MalformedURLException {
                ...
                RemoteWebDriver driver = new RemoteWebDriver(
                                new URL("http://localhost:8082/wd/hub"), capabilities);
                return driver;
        }
        ...
        public static void takeScreenshot(WebDriver driver, String screenshotType,
                ...
                /*
                 * 1. Check if the folder "/screenshots" exists, create if it doesn't 2. Generate a
                 * unique string using the timestamp 3. Capture screenshot 4. Save the screenshot
                 * inside the "/screenshots" folder using the following naming convention:
        ...
        public static Boolean TestCase01(RemoteWebDriver driver) throws InterruptedException {
                ...
                takeScreenshot(driver, "verify user registration", "screenshot");
        ...
        public static Boolean TestCase02(RemoteWebDriver driver) throws InterruptedException {
                ...
                logStatus("Start Testcase",
                                ...
                                "DONE");
                takeScreenshot(driver, "verify user not allowed to re-register", "screenshot");
                // Visit the Registration page and register a new user
                Register registration = new Register(driver);
                registration.navigateToRegisterPage();
                status = registration.registerUser("testUser", "abc@123", true);
        ...
        public static Boolean TestCase03(RemoteWebDriver driver) throws InterruptedException {
                logStatus("TestCase 3", "Start test case : Verify functionality of search box ",
                                "DONE");
                takeScreenshot(driver, "verify functionality of search text box", "screenshot");
        ...
        public static Boolean TestCase04(RemoteWebDriver driver) throws InterruptedException {
                ...
                takeScreenshot(driver, "verify size chart link and content of size chart",
                                "screenshot");
                return status;
        }
        ...
        public static Boolean TestCase05(RemoteWebDriver driver) throws InterruptedException {
                ...
                logStatus("Start TestCase", "Test Case 5: Verify Happy Flow of buying products",
                                "DONE");
                takeScreenshot(driver, "verify checkout and place order", "screenshot");
        ...
        public static Boolean TestCase06(RemoteWebDriver driver) throws InterruptedException {
                ...
                takeScreenshot(driver, "verify quantity of items can be updated ", "screenshot");
                Home homePage = new Home(driver);
                Register registration = new Register(driver);
                Login login = new Login(driver);
        ...
        public static Boolean TestCase07(RemoteWebDriver driver) throws InterruptedException {
                ...
                logStatus("Start TestCase",
                                ...
                                "DONE");
                takeScreenshot(driver, "verify cart contents are persisted after logout",
                                "screenshot");
                Register registration = new Register(driver);
                Login login = new Login(driver);
                Home homePage = new Home(driver);
        ...
        public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException {
                ...
                takeScreenshot(driver, "verify insufficient balance error is thrown", "screenshot");
        ...
        public static Boolean TestCase09(RemoteWebDriver driver) throws InterruptedException {
                ...
                logStatus("Start TestCase", "Test Case 9: Test case for multitab scenario ",
                                "DONE");
                ...
                wait.until(ExpectedConditions
                                .visibilityOfAllElementsLocatedBy(By.tagName("button")));
        ...
        public static Boolean TestCase10(RemoteWebDriver driver) throws InterruptedException {
                ...
                for (String handle : s) {
                        if (!handle.equalsIgnoreCase(parentWindow)) {
                                ...
                                String expectedcontentOfPrivacyPolicy =
                                                driver.findElement(By.tagName("h2")).getText();
                                String actualContentOfPrivacyPolicy =
                                                driver.findElement(By.tagName("h2")).getText();
                                if (expectedcontentOfPrivacyPolicy
                                                .equals(actualContentOfPrivacyPolicy)) {
                                        status = true;
                                }
                                driver.close();
                        }
        ...
        public static Boolean TestCase11(RemoteWebDriver driver) throws InterruptedException {
                ...
                logStatus("Start TestCase", "Test Case 11: Verify contact us link is working fine",
                                "DONE");
                Register registration = new Register(driver);
                registration.navigateToRegisterPage();
                ...
                logStatus("Step complete", "Entering details in contact us page ",
                                status ? "PASS" : "FAIL");
                logStatus("End test case 11", "Verify contact us pop up disappears",
                                status ? "PASS" : "FAIL");
                return status;
        }
        ...
        public static Boolean TestCase12(RemoteWebDriver driver) throws InterruptedException {
                ...
                WebDriverWait wait = new WebDriverWait(driver, 30);
                JavascriptExecutor js = (JavascriptExecutor) driver;
                logStatus("Start TestCase", "Test Case 12: Verify ads are displayed correctly",
                                "DONE");
                Register registration = new Register(driver);
                registration.navigateToRegisterPage();
                registration.registerUser("testUser", "abc@123", true);
                ...
                WebElement adframeOne = driver.findElement(By.xpath(
                                "//div[@class = 'greeting-container MuiBox-root css-0']/div/iframe[1]"));
                String currentUrl = driver.getCurrentUrl();
                driver.switchTo().frame(adframeOne);
                driver.findElement(By.tagName("button")).click();
                driver.switchTo().parentFrame();
                status = !driver.getCurrentUrl().equals(currentUrl);
                logStatus("Step pass", "Validated ad one button is clickable",
                                status ? "PASS" : "FAIL");

                driver.get(currentUrl);

                WebElement adframeTwo = driver.findElement(By.xpath(
                                "//div[@class = 'greeting-container MuiBox-root css-0']/div/iframe[2]"));
                driver.switchTo().frame(adframeTwo);
                driver.findElement(By.tagName("button")).click();
                driver.switchTo().parentFrame();
                status = !driver.getCurrentUrl().equals(currentUrl);
                logStatus("Step pass", "Validated ad two button is clickable",
                                status ? "PASS" : "FAIL");
